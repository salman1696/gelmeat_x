...
const PickAddress = ({ navigation }: any) => {
  ...
  const [addlocaiton, setaddlocaiton] = useState('');
  ...
  const fetchAddress = () => {
    console.log(region.latitude, 'region.latitud');
    ...
    fetch(
      ...
      .then((responseJson) => {
        ...
        console.log('[Fetch address]', userLocation);
          ...
          <View style={{
            ...
            <GooglePlacesAutocomplete
              ...
              onPress={(data, details = null) => {
                ...
                console.log(data, details, 'asd');
                setStrLoc(data?.description)
                Geocoder.from(data?.description)
                  .then(json => {
                    var location = json.results[0].geometry.location;
                    console.log(location, "loocation");
                    setRegionMap({
                      ...regionMap,
          ...
          <View style={{ flexDirection: 'row', position: 'absolute', width: "100%", bottom: 0 }}>
            <TouchableOpacity
              ...
              style={{
                ...
                borderColor: '#CA2323',
                borderWidth: 1,
                height: RF(55), borderRadius: 30,
                alignSelf: 'center',
                marginBottom: RF(20), width: '45%', padding: 20,
                backgroundColor: 'white'
              }} >
              <Text style={styles.get_started}>{t('Skip For Now')}</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
              ...
              <Text style={[styles.get_started, { color: 'white' }]}>{t('Save As')} </Text>
