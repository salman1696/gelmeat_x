  ...
  return (
    <Formik
      ...
      validationSchema={yup.object().shape({
        name: yup.string().required("Please, provide card holder name!"),
        cardNumber: yup.number().required("Please, provide card number!"),
        expiryDate: yup.string().required("Please, provide expiry date!"),
        cvc: yup.string().required("Please, provide CVC"),
      })}
    >
      {({
        values,
